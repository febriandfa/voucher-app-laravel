...
export default function EditVoucherType() {
    const { mVoucherType } = usePage().props as { mVoucherType?: MVoucherType };
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: route('m-voucher-type.edit', mVoucherType?.id),
        },
    ];
    ...
    const handleOnSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(route('m-voucher-type.update', mVoucherType?.id));
    };
